...
export const practicalWeakness: WeaknessCard[] = [
  ...
  {
    id: 'w25',
    keyword: '접근통제 DAC/MAC/RBAC',
    question: 'DAC, MAC, RBAC의 차이점은?',
    answer: '접근통제 3가지\n\n【DAC】Discretionary (임의적)\n- 소유자가 권한 결정\n- 신분/식별자 기반\n\n【MAC】Mandatory (강제적)\n- 보안등급/레벨 비교\n- 관리자가 중앙 통제\n\n【RBAC】Role-Based (역할기반)\n- 역할/직무별 권한 부여\n- 중앙에서 역할 관리',
    category: 'system',
    hint: 'DAC=소유자, MAC=등급, RBAC=역할',
  },
  {
    id: 'w26',
    keyword: 'ARP vs RARP',
    question: 'ARP와 RARP의 차이점은?',
    answer: 'ARP vs RARP\n\n【ARP】Address Resolution Protocol\n- IP → MAC 변환\n- "이 IP의 MAC 주소는?"\n\n【RARP】Reverse ARP\n- MAC → IP 변환\n- "내 MAC은 이건데, 내 IP는?"\n- 디스크 없는 단말기용\n\n※ RARP 대체: BOOTP, DHCP',
    category: 'network',
    hint: 'ARP=IP→MAC, RARP=MAC→IP(Reverse)',
  },
  {
    id: 'w27',
    keyword: 'VLAN 4종류',
    question: 'VLAN의 4가지 종류와 특징은?',
    answer: 'VLAN 4종류\n\n【Static VLAN】\n- 포트 기반, 수동 할당\n\n【Dynamic VLAN】\n- MAC 주소 기반, 자동 할당\n\n【End-to-End VLAN】\n- 위치 이동해도 같은 VLAN 유지\n- 업무별 할당\n\n【Local VLAN】\n- 위치 이동 시 다른 VLAN 소속\n- 장애 파악 용이',
    category: 'network',
    hint: 'Static=포트, Dynamic=MAC, E2E=같이감, Local=지역별',
  },
  {
    id: 'w28',
    keyword: 'CIO vs CISO',
    question: 'CIO와 CISO의 차이점은?',
    answer: 'CIO vs CISO\n\n【CIO】Chief Information Officer\n- 정보기술 총괄 (IT 전략)\n- 정보기술부문 계획 수립\n\n【CISO】Chief Information Security Officer\n- 정보보안 담당\n- 보안 정책/관리\n\n【기타】\n- CPO: 개인정보보호\n- CFO: 재무\n- COO: 운영',
    category: 'law',
    hint: 'CIO=기술, CISO=보안(Security)',
  },
  {
    id: 'w29',
    keyword: 'Update vs Upgrade',
    question: 'Update와 Upgrade의 차이점은?',
    answer: 'Update vs Upgrade\n\n【Update (업데이트)】\n- 보안 취약점/버그 패치\n- 같은 버전 내 수정\n- 예: 보안 패치\n\n【Upgrade (업그레이드)】\n- 품질/성능 향상\n- 상위 버전으로 변경\n- 예: Windows 10→11',
    category: 'system',
    hint: 'Update=날짜(패치), Upgrade=등급(성능)',
  },
  {
    id: 'w30',
    keyword: 'HTTP HEAD 메서드',
    question: 'HTTP HEAD 메서드의 특징은?',
    answer: 'HTTP HEAD 메서드\n\n【특징】\n- 헤더만 반환 (Body 없음)\n- 서버 상태 확인용\n- 리소스 존재 여부 확인\n- 대역폭 절약\n\n【GET과 비교】\n- GET: 헤더 + Body\n- HEAD: 헤더만\n\n【기타 메서드】\nPOST(생성), PUT(전체수정), PATCH(일부수정), DELETE(삭제), OPTIONS(지원확인)',
    category: 'application',
    hint: 'HEAD=머리=헤더만',
  },
  {
    id: 'w31',
    keyword: 'XSS 3종류',
    question: 'XSS(Cross-Site Scripting)의 3가지 종류는?',
    answer: 'XSS 3가지 종류\n\n【Stored XSS】\n- 서버에 저장됨\n- 게시판, 방명록에 악성 스크립트 저장\n- 피해자가 게시물 열면 실행\n\n【Reflected XSS】\n- URL에 스크립트 포함\n- 서버가 반사하여 실행\n- 이메일/링크로 유도\n\n【DOM-based XSS】\n- 클라이언트에서 DOM 조작\n- 서버 거치지 않음',
    category: 'application',
    hint: 'Stored=저장, Reflected=반사, DOM=브라우저',
  },
  {
    id: 'w32',
    keyword: '운영체제 명령어 삽입',
    question: '운영체제 명령어 삽입(OS Command Injection)이란?',
    answer: '운영체제 명령어 삽입\n\n【정의】\n외부 입력값이 필터링 없이 OS 명령어로 실행되어 공격자가 시스템 명령어 조작\n\n【공격 예시】\n; cat /etc/passwd\n| ls -la\n&& rm -rf /\n\n【대응】\n- 입력값 검증/필터링\n- 화이트리스트 방식\n- 특수문자 제거 (; | & $ 등)',
    category: 'application',
    hint: '필터링 없이 OS 명령 실행 → 명령어 삽입',
  },
];
